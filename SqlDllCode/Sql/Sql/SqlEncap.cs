...
public class SqlEncap {
    ...
    /// <returns></returns>
    public string Select(List<string> selectValue, string tableName,
        ...
        for (int i = 0; i < condition.Count(); i++) {
            ...
            result += condition.ElementAt(i).Key + " = " +
                      condition.ElementAt(i).Value;
        }
    ...
    /// <returns></returns>
    public string Insert(string tableName, List<string> columName,
                         List<string> value) {
        if (tableName == null)
            return "error";
    ...
    /// <param name="setValue">The column name and value which you want
    /// update</param> <param name="condition">Additional selection
    /// criteria</param> <returns></returns>
    public string Update(string tableName, Dictionary<string, string> setValue,
                         Dictionary<string, string> condition) {
        ...
        for (int i = 0; i < setValue.Count(); i++) {
            ...
            result +=
                setValue.ElementAt(i).Key + " = " + setValue.ElementAt(i).Value;
        }
